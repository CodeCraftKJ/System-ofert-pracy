...
namespace SzkolenieTechniczne.Common.CrossCutting.ValidationAttributes
{
    public class LocalizedStringRequiredAttribute : RequiredAttribute
    {
        ...
        private readonly LocalizedStringRequirementType _requiredRequirementType;
        public LocalizedStringRequiredAttribute(LocalizedStringRequirementType requiredType = LocalizedStringRequirementType.AtLeastOneLanguage)
        {
            _requiredRequirementType = requiredType;
        }
        public override bool IsValid(object value)
        {
            ...
            {
                if(_requiredRequirementType == LocalizedStringRequirementType.AtLeastOneLanguage)
                {
